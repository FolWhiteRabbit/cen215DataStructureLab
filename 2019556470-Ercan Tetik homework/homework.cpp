...
void merge(int arr[], int e, int l, int t) {
	int i, j, k, a1, a2;
	a1 = l - e + 1;
	a2 = t - l;
	int L[a1], R[a2];
...
void mergesort(int arr[], int e, int t	) {
...
void mergesortchar(char arr[], int e, int t) {

	if (e < t) {
		int l = (e + t) / 2;
		mergesortchar(arr, e, l);
		mergesortchar(arr, l + 1, t);
		mergechar(arr, e, l, t);
	}
}
...
int main() {
	...
	char name[] = "Ercan Tetik";
	int size = sizeof(number) / sizeof(number[0]);

	printf("My number: 2019556470.\n");
	printf("My name: Ercan Tetik.\n");
